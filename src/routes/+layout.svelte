	...
	<footer class="bg-homigo-dark pt-16 pb-0 text-white">
		<div class="container mx-auto px-4">
			...
			<div class="flex flex-col items-center gap-6 w-full mt-0 md:flex-row md:justify-between md:items-end">
				<a href="https://vikncodes.com" target="_blank" rel="noopener noreferrer" class="order-1 flex items-center gap-3 px-3 py-2 mb-4 text-white font-['Satoshi'] text-[18px] font-normal leading-[132.2%] md:order-2 md:mb-0">
